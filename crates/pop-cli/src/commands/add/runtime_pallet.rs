...
pub struct AddRuntimePalletCommand {
	#[arg(short, long, required = true, help = "Specify the path to the runtime crate.")]
	pub(crate) path: PathBuf,
	#[arg(long, value_enum, num_args(1..), required = false, help = "The pallets you want to include to your runtime.")]
