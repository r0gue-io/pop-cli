...
mod tests {
	...
	async fn construct_extrinsic_works() -> Result<()> {
		let transfer_allow_death= Function { pallet: "Balances".into(), name: "transfer_allow_death".into(), index: 0, docs: "Transfer some liquid free balance to another account. `transfer_allow_death` will set the `FreeBalance` of the sender and receiver. If the sender's account is below the existential deposit as a result of the transfer, the account will be reaped. The dispatch origin for this call must be `Signed` by the transactor.".into(), params: [Param { name: "dest".into(), type_name: "MultiAddress<AccountId32 ([u8;32]),()>: Id(AccountId32 ([u8;32])), Index(Compact<()>), Raw([u8]), Address32([u8;32]), Address20([u8;20])".into(), sub_params: [Param { name: "Id".into(), type_name: "".into(), sub_params: [Param { name: "Id".into(), type_name: "AccountId32 ([u8;32])".into(), sub_params: [Param { name: "Id".into(), type_name: "[u8;32]".into(), sub_params: [].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: false }].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: false }].to_vec(), is_optional: false, is_tuple: false, is_variant: true, is_sequence: false }, Param { name: "Index".into(), type_name: "".into(), sub_params: [Param { name: "Index".into(), type_name: "Compact<()>".into(), sub_params: [].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: false }].to_vec(), is_optional: false, is_tuple: false, is_variant: true, is_sequence: false }, Param { name: "Raw".into(), type_name: "".into(), sub_params: [Param { name: "Raw".into(), type_name: "[u8]".into(), sub_params: [].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: true }].to_vec(), is_optional: false, is_tuple: false, is_variant: true, is_sequence: false }, Param { name: "Address32".into(), type_name: "".into(), sub_params: [Param { name: "Address32".into(), type_name: "[u8;32]".into(), sub_params: [].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: false }].to_vec(), is_optional: false, is_tuple: false, is_variant: true, is_sequence: false }, Param { name: "Address20".into(), type_name: "".into(), sub_params: [Param { name: "Address20".into(), type_name: "[u8;20]".into(), sub_params: [].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: false }].to_vec(), is_optional: false, is_tuple: false, is_variant: true, is_sequence: false }].to_vec(), is_optional: false, is_tuple: false, is_variant: true, is_sequence: false }, Param { name: "value".into(), type_name: "Compact<u128>".into(), sub_params: [].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: false }].to_vec(), is_supported: true };
		// Wrong parameters
		assert!(matches!(
			construct_extrinsic(
	...
	async fn construct_sudo_extrinsic_works() -> Result<()> {
		let force_transfer= Function { pallet: "Balances".into(), name: "force_transfer".into(), index: 0, docs: "Exactly as `transfer_allow_death`, except the origin must be root and the source account may be specified".into(), params: [Param { name: "dest".into(), type_name: "MultiAddress<AccountId32 ([u8;32]),()>: Id(AccountId32 ([u8;32])), Index(Compact<()>), Raw([u8]), Address32([u8;32]), Address20([u8;20])".into(), sub_params: [Param { name: "Id".into(), type_name: "".into(), sub_params: [Param { name: "Id".into(), type_name: "AccountId32 ([u8;32])".into(), sub_params: [Param { name: "Id".into(), type_name: "[u8;32]".into(), sub_params: [].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: false }].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: false }].to_vec(), is_optional: false, is_tuple: false, is_variant: true, is_sequence: false }, Param { name: "Index".into(), type_name: "".into(), sub_params: [Param { name: "Index".into(), type_name: "Compact<()>".into(), sub_params: [].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: false }].to_vec(), is_optional: false, is_tuple: false, is_variant: true, is_sequence: false }, Param { name: "Raw".into(), type_name: "".into(), sub_params: [Param { name: "Raw".into(), type_name: "[u8]".into(), sub_params: [].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: true }].to_vec(), is_optional: false, is_tuple: false, is_variant: true, is_sequence: false }, Param { name: "Address32".into(), type_name: "".into(), sub_params: [Param { name: "Address32".into(), type_name: "[u8;32]".into(), sub_params: [].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: false }].to_vec(), is_optional: false, is_tuple: false, is_variant: true, is_sequence: false }, Param { name: "Address20".into(), type_name: "".into(), sub_params: [Param { name: "Address20".into(), type_name: "[u8;20]".into(), sub_params: [].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: false }].to_vec(), is_optional: false, is_tuple: false, is_variant: true, is_sequence: false }].to_vec(), is_optional: false, is_tuple: false, is_variant: true, is_sequence: false }, Param { name: "value".into(), type_name: "Compact<u128>".into(), sub_params: [].to_vec(), is_optional: false, is_tuple: false, is_variant: false, is_sequence: false }].to_vec(), is_supported: true };
		let xt = construct_extrinsic(
			&force_transfer,
			vec![
				"Id(5FHneW46xGXgs5mUiveU4sbTyGBzmstUspZC92UhjJM694ty)".to_string(),
